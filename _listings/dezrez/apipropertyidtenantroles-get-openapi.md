...
x-complete: 0
info:
  title: Dezrez Get a list of all current and ended tenant roles from a property id.
  version: 1.0.0
  description: Get a list of all current and ended tenant roles from a property id..
host: api.dezrez.com
basePath: /
schemes:
- http
